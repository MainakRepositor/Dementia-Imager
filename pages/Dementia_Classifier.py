...
st.title("Brain MRI Based Dementia Detection")
    ...
    if y.strip() == "Safe":
        components.html(
            ...
            h1{
                ...
                background: -webkit-linear-gradient(0.25turn,#00ff15, #63ff70);
                -webkit-background-clip: text;
                -webkit-text-fill-color: transparent;
                font-family: "Source Sans Pro", sans-serif;
            }
            </style>
            <h1>Least changes of Dementia</h1>
            """
        )
    elif y.strip() == "Glioma":
        components.html(
            ...
            <style>
            h1{
                background: -webkit-linear-gradient(0.25turn,#ffda08, #ffed87);
                -webkit-background-clip: text;
                -webkit-text-fill-color: transparent;
                font-family: "Source Sans Pro", sans-serif;
            }
            </style>
            <h1>Medium Risk of Dementia</h1>
            """
        )
        ...
        components.html(
            ...
            <style>
            h1{
                background: -webkit-linear-gradient(0.25turn,#ff008c, #f084bf);
                -webkit-background-clip: text;
                -webkit-text-fill-color: transparent;
                font-family: "Source Sans Pro", sans-serif;
            }
            </style>
            <h1>Previously suffered from Dementia and has Alzheimer</h1>
            """
        )
